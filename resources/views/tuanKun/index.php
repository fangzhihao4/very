...
<div class="right_col" role="main">
    <div class="x_panel">
        ...
        <div>
            <form action="<?php echo url('/tuanKun/index'); ?>" class="form-inline" method="get">
                <ul class="nav nav-pills">
                    <li>
                        <input type="file" onchange="batchUploadStoreInfo(this,'/tuanKun/batchUploadStoreInfo')"
...
<script>
    ...
    function handleAjaxResponse(res) {
        if (res.retcode == 200) {
            alertPrompt(res.msg, 6, '/tuanKun/index');
        } else {
            alertPrompt(res.msg, 5, '/tuanKun/index');
        }
    }
            ...
            success:function(res){
                ...
                if(res.retcode!=200){
                    ...
                    layer.alert(res.msg, {
                        ...
                        window.location.href = '/tuanKun/index';
                    });
                }
            }
        });
