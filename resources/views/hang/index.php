...
<!--            <div class="">-->
<!--                <a style="float: right" href="/hang/downloadFile" style="color: #00a0e9">点击下载上传示例</a>-->
<!--            </div>-->
            <div class="clearfix"></div>
        </div>

        <div>
            <form action="<?php echo url('/hang/index'); ?>" class="form-inline" method="get">
                <ul class="nav nav-pills">
                    <li>
                        <input type="file" onchange="batchUploadStoreInfo(this,'/hang/batchUploadStoreInfo')"
                ...
                <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                    ...
                    <?php foreach ($list as $k => $v) { ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" onclick="javascript:location.href='/hang/download?upload_id=' + <?php echo !empty($v->id) ? $v->id : ''; ?>"
